...
curl -o "C:\Users\Public\Desktop\RunManualyDownload.bat" https://raw.githubusercontent.com/THrownCreeper/W10_RDP/main/Files/RunManualyDownload.bat > out.txt 2>&1
